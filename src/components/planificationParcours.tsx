  ...
  return (
    <div key={id} className="text-xl my-4">
      <div className="flex flex-row mr-10">
        <div
            className="w-52 h-20 bg-lightlightgrey shadow-md rounded-xl flex items-center content-center justify-center p-4">
          <p>{name}</p>
        </div>
        ...
        {/*</div>*/}
        <div className="w-48 h-20 bg-light-blue rounded-xl ml-12">
          <div
              className="w-full h-full bg-lightlightgrey text-4xl flex items-center justify-around shadow-md rounded-xl p-4 translate-x-[-0.3rem] translate-y-[-0.3rem]">
